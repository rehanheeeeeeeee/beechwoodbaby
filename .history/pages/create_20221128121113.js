...
const styles = {
  ...
  categoryContainer: (error, touched) =>
    `w-full p-2 capitalize rounded-md border ${
      error && tocuhed ? "border-red-300" : "border-gray-300"
    } shadow-md outline-none text-lg font-medium`,
  description:
  ...
  return type === "select" ? (
    <div className="space-y-2">
      ...
      <Field
        as={type}
        name={name}
        className={styles.categoryContainer(errors[name], touched[name])}
      >
