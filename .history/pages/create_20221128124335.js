...
const styles = {
  ...
  uploadIcon: "text-3xl",
  button:
    "my-6 w-full md:w-32 rounded-md hover:bg-green-600 transtion-all ease-in duration-200 bg-green-500 p-2 text-white flex items-center justify-center font-semibold text-lg",
  label:
    ...
    <div className={styles.container}>
      ...
      <div className={styles.formContainer}>
        <Formik
          ...
          onSubmit={(values, isValid, { resetForm, setSubmitting }) => {
            console.log("I ran");
            console.log(isValid);
