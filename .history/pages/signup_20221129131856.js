      ...
      <div className="w-full max-w-md space-y-8">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="group relative flex w-full justify-center rounded-md border border-transparent bg-textColor py-2 px-4 text-sm font-medium text-white hover:bg-headingColor focus:outline-none focus:ring-2 focus:ring-textColor focus:ring-offset-2"
            >
              Sign Up
            </button>
          </div>
