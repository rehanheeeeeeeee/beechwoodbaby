...
const styles = {
  formContainer: "p-3 border border-gray-300 rounded-lg ",
  inputContainer:
    "flex items-center space-x-2 border-b my-5 border-gray-300 p-1",
  input: "bg-transparent outline:hidden flex-1",
  inputIcon: "text-3xl text-textColor",
};
