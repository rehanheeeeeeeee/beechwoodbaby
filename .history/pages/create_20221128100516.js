...
const styles = {
  ...
  imageUpload:
    "w-full border-dashed h-58 border-gray-300 border-2 p-4 rounded-md flex items-center justify-center text-gray-500 text-lg font-medium flex-col space-y-2",
  uploadIcon: "text-2xl",
};
