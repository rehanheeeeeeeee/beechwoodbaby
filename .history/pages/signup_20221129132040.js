      ...
      <div className="w-full max-w-md space-y-8">
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="group relative flex w-full justify-center rounded-md border border-transparent  bg-gradient-to-tr from-blue-400 to-blue-600 transition-all ease-in duration-100 border-0 py-2 px-3 focus:outline-none hover:bg-blue-600 hover:shadow-lg shadow-sm  py-2 px-4 text-sm font-medium text-white hover:bg-headingColor focus:outline-none focus:ring-2 focus:ring-textColor focus:ring-offset-2"
            >
              Sign Up
            </button>
          </div>
