    ...
    <div className={styles.container}>
      <div className={styles.wrapper}>
        ...
        <div className="my-2 px-5 space-y-3">
          <div className="flex font-semibold text-xl w-full py-2 justify-between items-center">
            <p>Subtotal</p>
            <p>{basketTotal} BHD</p>
          </div>
          <div className="flex font-semibold text-xl border-b border-cartItem w-full py-2 justify-between items-center">
            <p>Delivery</p>
            <p>5.00 BHD</p>
          </div>
          <div className="flex font-bold text-xl border-b border-cartItem w-full py-2 justify-between items-center">
            <p>Total</p>
