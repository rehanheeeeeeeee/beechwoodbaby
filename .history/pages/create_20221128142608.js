...
export default function Create() {
  ...
  const ImageInput = ({ name, imageUrls }) => (
          ...
          {({ isValid, isSubmitting, touched, errors, handleSubmit }) => (
            <div className="">
              ...
              <div className="flex flex-col md:place-items-center md:grid md:grid-cols-2 lg:flex lg:flex-row gap-7">
                <ImageInput name="image1" imageUrls={imageUrls} />
                <ImageInput name="image2" imageUrls={imageUrls} />
                <ImageInput name="image3" imageUrls={imageUrls} />
              </div>
              <button
