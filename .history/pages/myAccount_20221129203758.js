  ...
  return (
    <div className="p-5">
      ...
      <form>
        ...
        <button
          type="submit"
          className="text-slate-50 bg-headingColor border-0 py-2 px-6 focus:outline-none hover:bg-gray-800 transition-all ease-in duration-200 rounded-md text-lg"
        >
          Update User Details
        </button>
      </form>
