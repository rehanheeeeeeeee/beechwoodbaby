...
const styles = {
  ...
  button:
    "flex my-4 px-5 text-white bg-gradient-to-tr from-red-400 to-red-600 transition-all ease-in duration-100 border-0 py-2 px-3 focus:outline-none hover:bg-red-600 hover:shadow-lg shadow-sm whitespace-nowrap  rounded",
};
