...
const styles = {
  ...
  description:
    "bg-transparent border-dashed border-gray-500 border rounded-md p-2 w-full outline-none",
  categoryHeading:
    "flex items-center space-x-3 font-medium text-lg text-gray-400",
  imageUpload:
    "w-full border-dashed border border-gray-500 border-2 p-4 rounded-md flex items-center justify-center text-gray-500 text-lg font-medium",
};
