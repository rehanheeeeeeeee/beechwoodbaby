...
const styles = {
  ...
  uploadIcon: "text-3xl",
  button:
    "my-4 w-full md:w-32 rounded-md hover:bg-green-600 transtion-all ease-in duration-100 bg-green-500 p-2 text-white font-semibold text-lg disabled:bg-gray-400",
};
