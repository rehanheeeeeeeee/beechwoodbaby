...
const styles = {
  ...
  imageUpload:
    "w-full border-dashed h-64 border-gray-300 border-2 p-4 rounded-md flex items-center justify-center text-gray-500 text-lg font-medium flex-col space-y-2",
  uploadIcon: "text-3xl",
  button:
    "my-4 w-full md:w-32 rounded-md hover:bg-green-700 transtion-all ease-in duration-100 bg-green-500 p-2 text-white font-semibold text-lg disabled:bg-gray-400",
};
...
export default function Create() {
  ...
  const ImageInput = ({ name }) => (
    <>
      <label for="image" className={styles.imageUpload}>
