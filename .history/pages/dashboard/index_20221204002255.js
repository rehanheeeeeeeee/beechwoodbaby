...
const styles = {
  container: "p-5",
  statusCard: "p-7 shadow-lg rounded-md my-2 bg-headingColor w-full",
};
...
export default function Dashboard({ orders, users }) {
  ...
  return (
    <div className={styles.container}>
      dashboard
      <div className="bg-card p-5 rounded-md shadow-lg w-full items-center flex flex-wrap space-y-5">
