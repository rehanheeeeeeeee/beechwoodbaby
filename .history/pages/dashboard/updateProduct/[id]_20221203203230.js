...
const styles = {
  ...
  delete:
    "bg-red-500 text-white p2 text-2xl hover:bg-red-600 transtion-all ease-in duration-200 cursor-pointer absolute right-max bottom-4 left-max rounded-full",
  confirmBtn:
