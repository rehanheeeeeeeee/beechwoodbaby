...
const styles = {
  ...
  wrapper: "my-2",
  uploadIcon: "text-3xl",
  description: `p-2 bg-transparent border-dashed my-2 text-textColor border-gray-400
    border rounded-md w-full outline-none`,
  label:
    "h-full w-full flex items-center justify-center text-gray-500 text-md font-medium flex-col cursor-pointer space-y-2",
  delete:
  ...
  categoryContainer: `w-full my-2 p-2 capitalize rounded-md border border-gray-300
