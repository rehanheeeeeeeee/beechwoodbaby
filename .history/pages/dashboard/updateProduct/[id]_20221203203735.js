...
const styles = {
  ...
  input:
    "px-2 py-1 my-2 w-full bg-primary rounded border border-gray-400 focus:border-gray-500 focus:ring-2 focus:ring-gray-200 text-base outline-none text-textColor leading-8 transition-colors duration-200 ease-in-out",
  wrapper: "",
  uploadIcon: "text-3xl",
