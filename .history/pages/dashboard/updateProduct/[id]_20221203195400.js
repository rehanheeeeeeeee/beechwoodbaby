...
const styles = {
  ...
  confirmBtn:
    "group md:w-[303px] relative flex w-full justify-center rounded-sm border border-transparent  bg-gradient-to-tr from-green-400 to-green-600 transition-all ease-in duration-100 border-0 py-2 px-3 focus:outline-none hover:shadow-md shadow-sm text-md font-medium text-white focus:outline-none whitespace-nowrap mr-5",
};
        ...
        >
          {({
            ...
            <div>
              ...
              <button className={styles.confirmBtn}>Confirm Changes</button>
            </div>
          )}
        </Formik>
      </div>
