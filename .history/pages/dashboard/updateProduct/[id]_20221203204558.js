...
const styles = {
  ...
  input:
    "px-2 py-1 w-full bg-primary rounded border border-gray-400 focus:border-gray-500 focus:ring-2 focus:ring-gray-200 text-base outline-none text-textColor leading-8 transition-colors duration-200 ease-in-out",
  wrapper: "my-2",
  uploadIcon: "text-3xl",
  description: `p-2 bg-transparent border-dashed text-textColor border-gray-400
  ...
  confirmBtn:
    "group md:w-[303px] relative flex justify-center rounded-sm border border-transparent  bg-gradient-to-tr from-green-400 to-green-600 transition-all ease-in duration-100 border-0 py-2 px-3 focus:outline-none hover:shadow-md shadow-sm text-md font-medium text-white focus:outline-none whitespace-nowrap",
        ...
        >
          {({
            ...
            <div className="w-full p-5">
              ...
              <div className="flex flex-col md:grid md:grid-cols-2 lg:flex lg:flex-row gap-7 my-5">
