    ...
    {images[image[0]] ? (
      ...
      <>
        ...
        <input
          id="image"
          className="hidden"
          onChange={(e) => handleFile(setImages, image, e.target.files[0],noImages,setNoImages)}
          type="file"
