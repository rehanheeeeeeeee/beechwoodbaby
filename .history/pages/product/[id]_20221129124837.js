        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          >
            ...
            <div className="flex">
              ...
              <button className="flex ml-auto text-white bg-gradient-to-tr from-green-400 to-green-600 border-0 py-2 px-3 transition-all ease-in duration-100 focus:outline-none hover:bg-shaodow-lg shadow-sm rounded">
                Buy Now
              </button>
              <button
                onClick={addToCart}
                className="flex ml-4 text-white bg-gradient-to-tr from-orange-400 to-orange-600 transition-all ease-in duration-100 border-0 py-2 px-3 focus:outline-none hover:bg-orange-600 rounded"
              >
                Add to Cart
              </button>
            </div>
