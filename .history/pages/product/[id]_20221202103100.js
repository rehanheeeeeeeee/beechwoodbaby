...
const styles = {
  imgContianer:
    "lg:w-1/2 w-full max-w-[450px]  lg:h-auto  rounded bg-primary flex flex-col items-center relative my-5",
};
          ...
          <div className={styles.imgContianer}>
            <div className="h-full w-full flex justify-center">
              <Image
                width={1920}
                height={1080}
                className="h-full object-center my-5 w-full flex justify-center"
                alt="JEKLDF"
                src={productImages[0]}
              />
            </div>
