...
const styles = {
  imgContianer:
    "lg:w-1/2 w-full max-w-[450px] space-y-5  lg:h-auto  rounded bg-primary flex flex-col lg:flex-row-reverse items-center relative my-5",
};
      ...
      <div className="container px-5 md:px-10 lg:px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap justify-center">
          <div className={styles.imgContianer}>
            ...
            <div className="flex items-center space-x-5 lg:flex-col">
