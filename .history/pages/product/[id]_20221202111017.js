...
import { addToWishlist, selectWishlistItems } from "../../redux/wishlistSlice";
        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap justify-center">
          ...
          >
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5 justify-between">
              ...
              <motion.button
                onClick={addWishlist}
                className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-auto"
              >
                <svg
                  fill="currentColor"
