      ...
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          >
            ...
            <div className="flex">
              <span className="title-font font-medium text-2xl text-gray-900 whitespace-nowrap">
                {price.toFixed(2)} BHD
              </span>
              <button className="flex ml-auto text-white bg-gradient-to-tr from-green-400 to-green-600 border-0 py-2 px-3 transition-all ease-in duration-100 focus:outline-none hover:shadow-lg whitespace-nowrap shadow-sm rounded">
                Buy Now
              </button>
              <button
                onClick={addToCart}
