        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap justify-center">
          ...
          >
            ...
            <div className="flex items-center">
              ...
              <button
                onClick={addToCart}
                className="flex ml-2 text-white bg-gradient-to-tr from-orange-400 to-orange-600 transition-all ease-in duration-100 border-0 py-2 px-3 focus:outline-none hover:bg-orange-600 hover:shadow-lg shadow-sm whitespace-nowrap  rounded"
              >
                Add to Cart
              </button>
            </div>
