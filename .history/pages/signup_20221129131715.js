    ...
    <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md space-y-8">
        <div>
          ...
          <Link
            href={"/login"}
            className="w-full text-center hover:text-headingColor duration-150 transition ease-in text-gray-500"
            legacyBehavior
          >
        ...
        >
          ...
          <div>
            <button
              type="submit"
              className="group relative flex w-full justify-center rounded-md border border-transparent bg-pink-600 py-2 px-4 text-sm font-medium text-white hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
            >
              Sign Up
            </button>
          </div>
