...
const styles = {
  ...
  label:
    "h-full w-full flex items-center justify-center text-gray-500 text-lg font-medium flex-col space-y-2",
  delete:
    "bg-red-500 text-white text-2xl h-20 absolute right-5 p-2 rounded-full",
};
