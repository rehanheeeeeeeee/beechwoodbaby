...
const styles = {
  ...
  logoText: "font-bold text-headingColor -ml-5 text-xl md:text-2xl",
...
const links = [
  { link: "cribs", icon: <MdCrib className={styles.icon} /> },
  { link: "purses", icon: <GiHandBag className={styles.icon} /> },
  { link: "bundles", icon: <BsHandbagFill className={styles.icon} /> },
  { link: "shams", icon: <GiPillow className={styles.icon} /> },
  { link: "clothes", icon: <IoShirt className={styles.icon} /> },
];
    ...
    <div className="">
      ...
      <div className={styles.bigWrapper}>
        ...
        <div className="flex items-center space-x-5">
          ...
          <IoMdBasket className={styles.icon} />
          <motion.img
      ...
      <div className="flex items-center w-full justify-center gap-3 mt-1 md:hidden group">
        {links.map(({ link, icon }, index) => (
          <Link
            key={index}
            className="flex flex-col-reverse justify-center items-center space-y-1"
            href={`/${link}`}
          >
