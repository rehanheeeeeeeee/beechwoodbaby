...
const styles = {
  ...
  link: "capitalize text-textColor font-medium text-[18px] hover:text-headingColor transition-all ease-in duration-100",
  options: "flex space-x-5",
  bigWrapper: "md:flex hidden px-2 items-center justify-between ",
  icon: "text-[32px] hover:text-textColor  transition-all md:px-4 ease-in duration-100 cursor-pointer",
