...
const styles = {
  ...
  dropdown:
    "shadow-lg w-36  bg-gray-50 rounded-lg md:hidden top-[50px] absolute right-10",
  dropdownLink:
    "text-lg font-medium py-1.5 w-30 px-3 hover:shadow-md text-left text-headingColoe rounded-lg hover:bg-slate-200 transition-all ease-in duration-100 font-medium",
};
