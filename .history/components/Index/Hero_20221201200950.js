...
const styles = {
  delivery:
    "flex items-center rounded-[50px] w-fit bg-orange-100 py-1 px-3 space-x-2 absolute left-8 top-10",
};

export default function Hero() {
  return (
    <section className="body-font">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center relative animate-in fade-in duration-300 delay-150">
