...
const styles = {
  delivery:
    "flex items-center rounded-[50px] w-fit bg-orange-100 py-1 px-3 space-x-2 absolute left-10 top-10",
};
  ...
  return (
    <section className="body-font">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center relative">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 pt-4 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
