...
const styles = {
  delivery:
    "flex items-center rounded-[50px] w-fit bg-orange-100 py-1 px-3 space-x-2 absolute left-8 md:left-10 top-10",
};
      ...
      <div className="container mx-auto flex px-7 py-24 md:px-14 md:flex-row flex-col items-center relative">
        <Fade left>
          <div className={styles.delivery}>
            ...
            <div className="h-8 w-8 p-1 bg-slate-50 shadow-md rounded-full">
              <Image
                alt=""
                width={1920}
                height={1080}
