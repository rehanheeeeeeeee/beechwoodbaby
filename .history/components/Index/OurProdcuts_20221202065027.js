...
const styles = {
  ...
  wrapper: "flex space-x-3 py-5",
  categories:
    "flex flex-col items-center bg-card p-2 justify-center rounded-md w-24 space-y-2 h-24",
  iconContainer: "text-card bg-headingColor rounded-full p-1",
};
