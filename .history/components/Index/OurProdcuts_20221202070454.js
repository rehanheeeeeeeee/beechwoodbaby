...
const styles = {
  ...
  wrapper:
    "flex space-x-7  justify-center  py-7 overflow-scroll scrollbar-hide",
  categories:
    "flex flex-col justify-center items-center group bg-card shadow-md p-2 hover:bg-headingColor group-hover:transition-all ease-in duration-200 justify-center rounded-md min-w-[120px] min-h-[120px] space-y-3 ",
  iconContainer:
