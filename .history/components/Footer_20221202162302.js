...
const socialMediaLinks = [
 <Link href={'https://www.instagram.com/beechwood__baby/'}><AiOutlineInstagram key={0} className={styles.icon} /></Link> ,
 <Link href={'https://www.facebook.com/profile.php?id=100071135809704'}><BsFacebook key={1} className={styles.icon} /></Link> ,
  <Link href={'https://www.twitter.com'}><BsTwitter key={2} className={styles.icon} /></Link>,
];
