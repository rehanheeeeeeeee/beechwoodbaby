...
const styles = {
  ...
  wrapper:
    "bg-cartBg h-full mt-10 justify-between rounded-t-[30px] pt-5 w-full flex flex-col justify-center",
};
    ...
    >
      ...
      {basket.length ? (
        <div className={styles.wrapper}>
          <div className="pt-4 px-5 overflow-scroll h-[60%] scrollbar-hide">
