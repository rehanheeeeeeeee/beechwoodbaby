...
export default function Sidebar() {
  ...
  return (
    <div
      className={`w-[230px] max-sm:fixed ${showSidebar ? 'max-sm:translate-x-0' : 'max-sm:-translate-x-full'} -mt-1 p-3 bg-headingColor sticky left-0 bottom-0 top-0 h-screen`}
    >
      <Image
        src={"/logo.png"}
        width={1920}
