...
import { selectShowSidebar } from "../../redux/sidebarSlice";
...
export default function Sidebar() {
  ...
  return (
    <div
      className={`w-[230px] max-sm:fixed transition-all ease-in duration-200 ${showSidebar ? 'max-sm:translate-x-0 opacity-100' : 'max-sm:-translate-x-full opacity-0'} -mt-1 p-3 bg-headingColor sticky left-0 bottom-0 top-0 h-screen z-30`}
    >
      <Image
        src={"/logo.png"}
        width={1920}
