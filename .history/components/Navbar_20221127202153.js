...
const styles = {
  ...
  smallWrapper: "flex items-center justify-between px-2 py-1 md:hidden",
  dropdown:
    "shadow-lg  bg-gray-50 rounded-lg absolute md:hidden p-3 top-30 space-y-4 right-10",
  dropdownLink: "text-sm px-2 text- rounded-md hover:bg-gray-100 font-medium",
};
