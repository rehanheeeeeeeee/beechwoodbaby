...
const styles = {
  ...
  contactBtn:
    "group md:w-[300px] relative flex w-full md:p-4 justify-center rounded-sm border border-transparent  bg-gradient-to-tr from-green-400 to-green-600 transition-all ease-in duration-100 border-0 py-2 px-3 focus:outline-none hover:shadow-md shadow-sm text-md font-medium text-white focus:outline-none whitespace-nowrap",
  returnBtn:
    "border border-slate-50 my-2 text-center p-2 md:p-4 rounded-sm hover:bg-slate-50 hover:text-headingColor transition-all ease-in duration-100",
};
