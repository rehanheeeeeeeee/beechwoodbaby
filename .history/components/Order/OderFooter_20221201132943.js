...
const styles = {
  ...
  contactBtn:
    "group relative flex w-full justify-center rounded-md border border-transparent  bg-gradient-to-tr from-blue-400 to-blue-600 transition-all ease-in duration-100 border-0 py-2 px-3 focus:outline-none hover:shadow-md shadow-sm text-md font-medium text-white focus:outline-none",
};
  ...
  return (
    <div className={styles.container}>
      ...
      <div className="flex flex-col">
        <Link className={styles.contactBtn}>Contact Us</Link>
        <Link className={styles.returnBtn}>RETURN</Link>
      </div>
    </div>
  );
}
