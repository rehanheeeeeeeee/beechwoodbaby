...
const styles = {
  ...
  returnBtn:
    "text-headingColor border border-textColor my-2 text-center p-2 md:p-3 rounded-sm hover:bg-headingColor hover:text-slate-50 transition-all ease-in duration-100",
};
