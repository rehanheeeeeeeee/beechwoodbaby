...
const styles = {
  ...
  wrapper: "flex items-start py-5 w-full text-slate-50 justify-between h-fit",
};
...
export default function OrderedProduct({ item }) {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className="flex space-y-1 py-1  flex-col items-center justify-between">
        <p className="font-semibold text-md md:text-2xl ">Total </p>
