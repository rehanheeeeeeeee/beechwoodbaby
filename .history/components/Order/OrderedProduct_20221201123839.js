  ...
  return (
    <div className={styles.wrapper}>
          ...
          <div className="flex md:mt-3 items-center md:space-x-10 space-x-5">
            <div className="flex items-center">
              ...
              <div
                ...
                }  rounded-full border-slate-50 w-1 h-1 md:w-4 md:h-4  border`}
              ></div>
            </div>
            <div className="flex items-center space-x-2 text-slate-50 text-xs md:text-base">
              <p>Size -</p>
      ...
      <div className="flex h-full flex-col">
        ...
        <p className="md:text-medium text-sm font-semibold">{price * quantity} BHD</p>
      </div>
    </div>
  );
}
