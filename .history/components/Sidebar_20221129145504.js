...
const styles = {
  container:
    "fixed bottom-0 top-0 right-0 w-full md:w-[360px] bg-gray-50 z-10 shadow-lg flex flex-col",
  clear:
    "mx-1 px-2 py-1 flex items-center text-slate-50 bg-headingColor space-x-1 rounded-md",
  wrapper:
    "bg-cartBg h-full mt-10 justify-between rounded-t-[30px] flex flex-col pt-5 w-full",
};
    ...
    >
      ...
      {basket.length ? (
        <div className={styles.wrapper}>
          <div className="pt-5 flex-1 px-5 h-[258px] overflow-scroll scrollbar-hide flex flex-col">
