...
const styles = {
  ...
  dropdown:
    "shadow-lg w-44 bg-gray-50 rounded-lg md:hidden top-[50px] absolute right-12 z-18",
  dropdownLink:
  ...
  dropdown2:
    "shadow-lg w-44 bg-gray-50 rounded-lg md:flex flex-col hidden top-[50px] absolute right-12",
};
