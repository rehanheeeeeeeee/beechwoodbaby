...
const styles = {
  ...
  payBtn:
    "block text-center w-full rounded-3xl mt-5 font-bold bg-gradient-to-tr from-orange-400 to-orange-600  text-gray-50 p-2 text-lg hover:shadow-lg",
};
  ...
  return (
    <div className={styles.container}>
      <div className={styles.card}>
        <div className="overflow-y-scroll scrollbar-hide h-[300px] mb-3">
