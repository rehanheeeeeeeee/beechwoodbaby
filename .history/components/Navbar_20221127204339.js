...
const styles = {
  ...
  dropdown:
    "shadow-lg w-40 bg-gray-50 rounded-lg md:hidden top-[55px] absolute right-10",
  dropdownLink:
  ...
  logout:
    "m-2 space-x-3  text-lg font-medium py-2 px-3 flex items-center shadow-md text-left text-headingColor rounded-lg bg-slate-200 ",
  logoutIcon: "text-2xl",
};
