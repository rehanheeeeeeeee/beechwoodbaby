...
const styles = {
  ...
  dropdown:
    "shadow-lg  bg-gray-100 rounded-lg md:hidden top-[50px] absolute right-10",
  dropdownLink:
    "text-medium font-medium py-1 px-3 text-textColor rounded-lg hover:bg-gray-300 transition-all ease-in duration-100 font-medium",
};
