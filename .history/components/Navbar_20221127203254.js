...
const styles = {
  ...
  dropdown:
    "shadow-lg  bg-gray-50 rounded-lg md:hidden top-[50px] absolute right-10",
  dropdownLink:
    "text-lg font-medium py-1.5 w-24 px-2 text-left text-textColor rounded-lg hover:bg-slate-200 transition-all ease-in duration-100 font-medium",
};
