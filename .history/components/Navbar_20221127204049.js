...
const styles = {
  ...
  dropdownLink:
    "text-lg font-medium py-2 w-30 px-3 hover:shadow-md text-left text-headingColor rounded-lg hover:bg-slate-100 transition-all ease-in duration-100 font-medium",
  logout:
    "m-2  text-lg font-medium py-2 px-3 shadow-md text-left text-headingColor rounded-lg bg-slate-200 ",
};
