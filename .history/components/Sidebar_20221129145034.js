...
const styles = {
  container:
    "fixed -bottom-0.5 top-0 right-0 w-full md:w-[360px] bg-gray-50 z-10 shadow-lg flex flex-col",
  clear:
    ...
    >
      ...
      {basket.length ? (
        <div className={styles.wrapper}>
          <div className="pt-5 px-5 h-[258px] overflow-scroll scrollbar-hide">
