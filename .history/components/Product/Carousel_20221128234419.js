...
const styles = {
  slider: "lg:w-1/2 w-full lg:h-auto  rounded bg-primary relative -z-12",
  rightIcon:
    "text-4xl absolute top-[50%] cursor-pointer text-headingColor right-3",
  leftIcon:
    "text-4xl  absolute top-[50%]  cursor-pointer text-headingColor  z-24",
};
  ...
  return (
    <>
      <div
        ...
        onClick={onClick}
      ></div>
      <IoIosArrowDropleftCircle onClick={onClick} className={styles.leftIcon} />
    </>
  );
};
