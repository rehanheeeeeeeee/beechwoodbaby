...
const styles = {
  container:
    "bg-[#f9f9f9] text-cartItem shadow-md hover:shadow-lg transtion-all ease-in duration-200 w-full my-2 flex items-center p-3 justify-between rounded-md",
  productInfo: "flex items-center space-x-2 text-cartItem text-sm",
  quantityContainer: "flex items-center space-x-3 text-cartItem",
  quantity:
