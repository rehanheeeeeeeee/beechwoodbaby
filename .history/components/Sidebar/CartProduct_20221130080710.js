...
const styles = {
  container:
    "bg-cardOverlay shadow-sm hover:shadow-lg transtion-all ease-in duation-200 w-full my-2 flex items-center p-3 justify-between rounded-md",
  productInfo: "flex items-center space-x-2 text-white text-sm",
