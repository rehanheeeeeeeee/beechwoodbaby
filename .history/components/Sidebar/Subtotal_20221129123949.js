...
const styles = {
  ...
  checkoutBtn:
    "w-full rounded-3xl my-1 w-full bg-gradient-to-tr from-orange-400 to-orange-600  text-gray-50 p-2 text-lg hover:shadow-lg",
};
...
export default function Subtotal() {
  ...
  return (
    <div className="bg-cartTotal rounded-t-[28px] px-8 py-6">
