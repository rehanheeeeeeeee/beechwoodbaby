...
const styles = {
  ...
  logout:
    "m-2 space-x-3  text-lg font-medium py-2 px-3 flex items-center shadow-md text-left text-headingColor rounded-lg bg-slate-200 hover:bg-slate-300 cursor-pointer",
  logoutIcon: "text-2xl",
};
