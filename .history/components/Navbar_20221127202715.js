...
const styles = {
  ...
  dropdown:
    "shadow-lg  bg-gray-50 rounded-lg md:hidden p-5 top-[50px] absolute space-y-4 right-10",
  dropdownLink:
    "text-medium font-medium py-1 px-3 text-textColor rounded-lg hover:bg-gray-100 font-medium",
};
