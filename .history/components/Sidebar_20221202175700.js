...
const styles = {
  container: (showSidebar) =>
    `fixed bottom-0 ${
      showSidebar ? "translate-x-0 opacity-1" : "translate-x-200 opacity-0"
    } top-0 z-16 right-0 w-full md:w-[360px] bg-gray-50 z-20  shadow-lg transition-all ease-in duration-200`,
  clear:
