...
const styles = {
  wrapper: (widthFix) =>
    `lg:w-1/4 flex flex-col md:w-1/2 p-4 
      ${widthFix && "min-w-[400px] min-h-[350px]"} w-full
  ...
  return (
    ...
    >
      <a className="block relative h-48 rounded overflow-hidden">
        <Image
          alt="ecommerce"
          className="object-contain object-center bg-[#f8f8f8] transition-all ease-in duration-200 py-2 shadow-lg group-hover:shadow-xl object-center w-full h-full block"
          src={showImage}
          width={1920}
          height={1080}
        />
