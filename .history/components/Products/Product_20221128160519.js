  ...
  return (
    <div className="lg:w-1/4 md:w-1/2 p-4 w-full group">
      <a className="block relative h-48 rounded overflow-hidden">
        <Image
          alt="ecommerce"
          className="object-contain bg-[#f9f9f9] transition-all ease-in duration-200 shadow-md group-hover:scale-105 group-hover:shadow-lg object-center w-full h-full block"
