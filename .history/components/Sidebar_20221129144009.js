...
const styles = {
  ...
  wrapper:
    "bg-cartBg flex-1 mt-10 justify-between rounded-t-[30px] flex flex-col pt-3 w-full",
};
    ...
    >
      ...
      {basket.length ? (
        <div className={styles.wrapper}>
          <div className="pt-3 px-5 md:h-[258px] flex-1 overflow-y-scroll scrollbar-hide">
