...
const styles = {
  logo: "flex items-center sm:-ml-2",
  logoText: "font-bold text-headingColor -ml-2 text-xl md:text-2xl",
  link: "capitalize text-textColor font-medium text-2xl text-[17px] hover:text-headingColor transition-all ease-in duration-100",
  options: "flex space-x-5",
  bigWrapper: "md:flex hidden px-2 items-center justify-between ",
  icon: "text-[32px] hover:text-textColor  transition-all ease-in duration-100 cursor-pointer",
